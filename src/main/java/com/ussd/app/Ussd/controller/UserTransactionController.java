...
//        }
            ...
            return getMenu("jours", input,"");
                ...
                input.matches("^3\\*[0-9]+\\*[0-9]{1,2}/[0-9]{1,2}/2[0-9]{3}")
                )){
            ...
            return getMenu("codeSecret", input,"");
                ...
                "+\\*[0-9]{4,5}")
            ||input.matches("^2\\*6[0-9]{8}\\*[0-9]+\\*[0-9]+\\*[0-9]{1,2}/[0-9]{1,2}/2[0-9]{3}+\\*[0-9]+\\*[0-9]{4,5}"))) {
            return getMenu("confirmation", input,"");

        }
        else if(( input.matches("^1\\*[0-9]+\\*[0-9]+\\*[0-9]{1,2}/[0-9]{1,2}/2[0-9]{3}+\\*[0-9]+\\*[0-9]{4,5}+\\*1")
                ||input.matches("^2\\*6[0-9]{8}\\*[0-9]+\\*[0-9]+\\*[0-9]{1,2}/[0-9]{1,2}/2[0-9]{3}+\\*[0-9]+" +
                "\\*[0-9]{4,5}+\\*1")|| input.matches("^3\\*[0-9]+\\*[0-9]{1,2}/[0-9]{1,2}/2[0-9]{3}+\\*[0-9]"))) {
